...
function getActiveColor() {
  return localStorage.getItem(KEY_ACTIVE_COLOR) || "#ff2d2d";
}
function getActiveName() {
  return localStorage.getItem(KEY_ACTIVE_NAME) || null;
}
function setActiveColor(color, name) {
  localStorage.setItem(KEY_ACTIVE_COLOR, color);
  if (name) localStorage.setItem(KEY_ACTIVE_NAME, name);
}
